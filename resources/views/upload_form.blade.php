...
<body class="index-page sidebar-collapse">
  ...
  <div class="container centered-form">
    <div class="form-container">
      <center>
        <h1 style="font-size: 30px">SUMMARY IMAGE-TO-TEXT</h1>
      </center>
      <form method="POST" action="{{ route('process.image') }}" enctype="multipart/form-data">
        @csrf
      ...
      <div class="usage-section">
        <div class="usage-points">
          <ul style="text-align: left">
            <li>Pilih gambar yang ingin Anda ubah menjadi teks.</li>
            <li>Klik tombol "Upload" untuk memproses gambar tersebut.</li>
            <li>Pastikan gambar yang diunggah jelas dan berisi teks yang dapat dikenali.</li>
          </ul>
        </div>
        <div class="usage-download">
          <a href="e-book/CARA-PENGGUNAAN-FITUR-IMAGE-TO-TEKS.pdf" download="Cara Penggunaan">Download e-book cara penggunaan (PDF)</a>
        </div>
      </div>
    </div>
  </div>
